...
int main()
{
	...
	tree.Insert(std::make_unique<float>(50.f));
	tree.Insert(std::make_unique<float>(49.f));
	tree.Insert(std::make_unique<float>(48.f));
	tree.Insert(std::make_unique<float>(47.f));
	tree.Insert(std::make_unique<float>(46.f));
	tree.Insert(std::make_unique<float>(50.f));
	tree.Insert(std::make_unique<float>(44.f));
	tree.Insert(std::make_unique<float>(43.f));
	tree.Search(50.f);
